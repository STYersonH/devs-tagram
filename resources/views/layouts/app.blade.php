        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex items-center gap-4">
                    <a href="{{route('posts.create')}}" class="flex items-center gap-2 bg-white border text-gray-600 rounded-2xl text-sm uppercase font-bold cursor-pointer px-2 hover:bg-gray-500 hover:text-white">
