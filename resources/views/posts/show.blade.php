        ...
        <div class="md:w-2/5">
            ...
            <div class="p-3 flex items-center justify-between border-b-2 border-gray-500 mb-5">
                ...
                @auth
                    ...
                    <!-- siempre usar comillas dobles para evitar problemas despues del = -->
                    <!-- <livewire:like-post :mensaje ="$mensaje" :post ="$post" /> --> <!-- $mensaje le asignamos un valor que se usara en todo el componente -->
                    <livewire:like-post :mensaje="$mensaje" :post="$post" />
